...
Consumer Reports Data (Overall Scores for Ranking) ETL tool to keep track of product rankings each in 43 product categories (~1600 total number of products)
